...
if __name__ == '__main__':
    """
    Mohammed Abdessetar Elyagoubi (abdessattar23), 2026-
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'U_kgDOBli_MQ'} and 2022-05-29T14:05:54Z for username 'abdessattar23'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2007, 5, 31))
    ...
    if OWNER_ID == {'id': 'U_kgDOBli_MQ'}: # only calculate for user abdessattar23
